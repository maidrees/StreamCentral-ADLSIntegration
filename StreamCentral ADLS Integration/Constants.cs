...
namespace StreamCentral.ADLSIntegration
{
    class Constants
    {
        public static readonly string _inputDSHeaderNameUnformatted = "SC_DSI_H_{0}{1}_{2}";

        public static readonly string _inputDSDataNameUnformatted = "SC_DSI_D_{0}{1}_{2}";

        public static readonly string _outputDSHeaderNameUnformatted = "SC_DSO_H_{0}{1}_{2}";
        ...
        public static readonly string _pipelineDataNameUnformatted = "SC_PL_D_{0}{1}_{2}";
        ...
        public static readonly string _datafileNameTransactionalAppender = "-{year}-{month}-{day}-{hour}-{minute}";
